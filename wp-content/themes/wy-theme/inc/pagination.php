...
if ( ! function_exists( 'understrap_pagination' ) ) {
	 ...
	 */
		function understrap_pagination( $args = array(), $class = 'pagination d-flex flex-row align-items-center justify-content-center' ) {
			...
			$args = wp_parse_args(
				...
				array(
					'mid_size'           => 2,
					'prev_next'          => true,
					'prev_text'          => __( 'Anterior', 'understrap' ),
					'next_text'          => __( 'Próximo', 'understrap' ),
					'type'               => 'array',
			...
			<nav aria-labelledby="posts-nav-label">
				<h2 id="posts-nav-label" class="sr-only"><?php echo esc_html( $args['screen_reader_text'] ); ?></h2>
